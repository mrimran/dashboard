...
jQuery(document).ready(function($) 
{
	...
	var area_chart = Morris.Area({
		...
		xkey: 'y',
		ykeys: ['a', 'b', 'c'],
		labels: ['No of Views', 'Calls', 'Emails'],
		lineColors: ['#d84a35', '#00a65a', '#00c0ef']
	});
...
<div class="row">
      <div class="col-sm-4">
        <ol class="breadcrumb bc-3">
          ...
          <li class="active"> <strong>Local Search</strong> </li>
        </ol>
      </div>
    ...
    <div class="row">
      <div class="col-sm-4"> <a href="javascript:void(0)">
        <div class="tile-stats tile-red">
          <div class="icon icon-fa"><i class="fa fa-eye"></i></div>
          <div class="num" data-start="0" data-end="3000" data-postfix="" data-duration="1500" data-delay="0">0</div>
          <h3>No of Views</h3>
      ...
      <div class="col-sm-4"> <a href="emails.html">
        <div class="tile-stats tile-aqua">
          ...
          <div class="num" data-start="0" data-end="10" data-postfix="" data-duration="1500" data-delay="1200">0</div>
          <h3>Emails</h3>
          <p>Since March 2013</p>
        </div>
        </a> </div>
    ...
    <div class="row">
      <div class="col-sm-12">
        <div class="action-links"> <a href="#">How Can I Improve This?</a>
          <hr />
        </div>
      </div>
    </div>
    ...
    <div class="row manage-links">
      <div class="col-sm-12">
        <h3><i class="fa fa-link"></i>Listing Preview: <a href="#">http://www.localsearch.com/preview</a></h3>
        <h3><i class="fa fa-link"></i>Manage Listings: <a href="#">http://www.localsearch.com/listings</a></h3>
      </div>
    </div>
      <br />
    <br />
