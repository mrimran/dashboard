    ...
    <div class="row">
      <div class="col-sm-4"> <a href="javascript:void(0)">
        <div class="tile-stats tile-red">
          ...
          <div class="num" data-start="0" data-end="178" data-postfix="" data-duration="1500" data-delay="0">0</div>
          <h3>New Leads</h3>
          <p>Lifetime Leads: 2700</p>
        </div>
        </a> </div>
      <div class="col-sm-4"> <a href="calls.html">
        <div class="tile-stats tile-green">
          <div class="icon"><i class="entypo-phone"></i></div>
          <div class="num" data-start="0" data-end="112" data-postfix="" data-duration="1500" data-delay="600">0</div>
          <h3>New Calls</h3>
          <p>Lifetime Calls: 200</p>
        </div>
        </a> </div>
      <div class="col-sm-4"> <a href="emails.html">
        <div class="tile-stats tile-aqua">
          <div class="icon"><i class="entypo-mail"></i></div>
          <div class="num" data-start="0" data-end="66" data-postfix="" data-duration="1500" data-delay="1200">0</div>
          <h3>New Emails</h3>
          <p>Lifetime Emails: 85</p>
        </div>
        </a> </div>
    </div>
    <br />
