...
// New Calls
$qry_new_calls = "SELECT * FROM calls WHERE call_start LIKE '%".date('Y-m-d')."%'"; 
...
// New Emails
$qry_new_emails = "SELECT * FROM emails WHERE email_date LIKE '%".date('Y-m-d')."%'"; 
...
jQuery(document).ready(function($) 
{
	...
	var area_chart = Morris.Area({
		...
		data: [
			{ y: '<?php echo $sixthYear?>', a: <?php echo $totalcountsixthYearCalls+$totalcountsixthYearEmails?>, b: <?php echo $totalcountsixthYearCalls?>, c: <?php echo $totalcountsixthYearEmails?> },
			
			{ y: '<?php echo $fifthYear?>', a: <?php echo $totalcountfifthYearCalls+$totalcountfifthYearEmails?>,  b: <?php echo $totalcountfifthYearCalls?>, c: <?php echo $totalcountfifthYearEmails?> },
			
			{ y: '<?php echo $fourthYear?>', a: <?php echo $totalcountfourthYearCalls+$totalcountfourthYearEmails?>,  b: <?php echo $totalcountfourthYearCalls?>, c: <?php echo $totalcountfourthYearEmails?> },
			
			{ y: '<?php echo $thirdYear?>', a: <?php echo $totalcountthirdYearCalls+$totalcountthirdYearEmails?>,  b: <?php echo $totalcountthirdYearCalls?>, c: <?php echo $totalcountthirdYearEmails?> },
			
			{ y: '<?php echo $secondYear?>', a: <?php echo $totalcountsecondYearCalls+$totalcountsecondYearEmails?>,  b: <?php echo $totalcountsecondYearCalls?>, c: <?php echo $totalcountsecondYearEmails?> },
			
			{ y: '<?php echo $firstYear?>', a: <?php echo $totalcountfirstYearCalls+$totalcountfirstYearEmails?>,  b: <?php echo $totalcountfirstYearCalls?>, c: <?php echo $totalcountfirstYearEmails?> },
			
			{ y: '<?php echo $currentYear?>', a: <?php echo $totalcountcurrentYearCalls+$totalcountcurrentYearEmails?>, b: <?php echo $totalcountcurrentYearCalls?>, c: <?php echo $totalcountcurrentYearEmails?> }
		],
		xkey: 'y',
		ykeys: ['a', 'b', 'c'],
		labels: ['Leads', 'Calls', 'Emails'],
		lineColors: ['#f56954', '#00a65a', '#00c0ef']
	});
...
function getRandomInt(min, max) 
{
    ...
    <div class="row">
      ...
      <div class="col-sm-4 fr"> <a href="javascript:;" onclick="jQuery('#modal-4').modal('show', {backdrop: 'static'});" class="btn btn-blue fr">Request A Call Now</a> </div>
    ...
    <div class="row">
      <div class="col-sm-4"> <a href="javascript:void(0)">
        <div class="tile-stats tile-red">
          ...
          <div class="num" data-start="0" data-end="<?php echo $totalcountNewCalls+$totalcountNewEmails;?>" data-postfix="" data-duration="1500" data-delay="0">0</div>
          <h3>New Leads</h3>
          <p>Lifetime Leads: <?php echo $totalcountCalls+$totalcountEmails;?></p>
        </div>
        </a> </div>
      <div class="col-sm-4"> <a href="calls.html">
        <div class="tile-stats tile-green">
          <div class="icon"><i class="entypo-phone"></i></div>
          <div class="num" data-start="0" data-end="<?php echo $totalcountNewCalls;?>" data-postfix="" data-duration="1500" data-delay="600">0</div>
          <h3>New Calls</h3>
          <p>Lifetime Calls: <?php echo $totalcountCalls;?></p>
        </div>
        </a> </div>
      <div class="col-sm-4"> <a href="emails.html">
        <div class="tile-stats tile-aqua">
          <div class="icon"><i class="entypo-mail"></i></div>
          <div class="num" data-start="0" data-end="<?php echo $totalcountNewEmails;?>" data-postfix="" data-duration="1500" data-delay="1200">0</div>
          <h3>New Emails</h3>
