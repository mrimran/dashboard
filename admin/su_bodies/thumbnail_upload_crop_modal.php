...
<script src="libs/uploadandcrop/assets/jcrop/js/jquery.Jcrop.js"></script>
<link rel="stylesheet" href="libs/uploadandcrop/assets/jcrop/css/jquery.Jcrop.css" type="text/css" />
<link rel="stylesheet" href="libs/uploadandcrop/assets/style.css" type="text/css" />
...
//        return;
            ...
            xhr.onreadystatechange = function(ev){
                ...
                if(xhr.readyState === 4){
                    ...
                    var imgHTML = "<img src=\"assets/images/thumbs/"+xhr.responseText+"\" id=\"crop_target\"\n\
                         class=\"img-responsive\">";
                    //alert(imgHTML);
                    document.getElementById('photo').innerHTML = imgHTML;
                    $pimg.attr('src',"assets/images/thumbs/"+xhr.responseText);
                    $('#crop_src').val("assets/images/thumbs/"+xhr.responseText);
            ...
            xhr.open('POST', 'libs/uploadandcrop/upload.php', true);
            ...
            formData.append('upload_and_crop_dest',"../../assets/images/thumbs/");
...
function crop(){
            ...
            xhr.open('POST', 'libs/uploadandcrop/crop.php', true);
