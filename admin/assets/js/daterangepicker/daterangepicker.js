        ...
        var DRPTemplate = '<div class="daterangepicker dropdown-menu">' +
				'<div class="ranges">' +
                  '<div class="range_inputs">' +
                    ...
                    '</div>' +
                    '<button class="' + this.applyClass + ' applyBtn" disabled="disabled" onClick="setSortVal(\''+range+'\')">' + this.locale.applyLabel + '</button>&nbsp;' +
        ...
        if (hasOptions) {
            ...
            if (typeof options.ranges == 'object') {
                ...
                for (var range in this.ranges) {
                    list += '<li onClick="setSortVal(\''+range+'\')">' + range + '</li>';
                }
